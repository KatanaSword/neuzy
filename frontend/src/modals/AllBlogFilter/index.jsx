        ...
        <div className="bg-white-A700 flex flex-col gap-14 items-start justify-start max-w-[1290px] mb-[1090px] mt-7 mx-auto p-[39px] md:px-5 rounded-[30px] w-full">
          ...
          <div className="flex flex-col gap-[27px] items-start justify-start md:ml-[0] ml-[27px] rounded-[10px] w-[71%] md:w-full">
            ...
            <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between rounded-[10px] w-full">
              ...
              <Button
                className="rounded-[10px] cursor-pointer leading-[normal] min-w-[113px] text-center text-lg tracking-[-0.50px]"
                shape="round"
                color="gray_50"
                size="sm"
              >
              ...
              <Button
                className="rounded-[10px] cursor-pointer leading-[normal] min-w-[104px] text-center text-lg tracking-[-0.50px]"
                shape="round"
                color="gray_50"
                size="sm"
              >
              ...
              <Button
                className="rounded-[10px] cursor-pointer leading-[normal] min-w-[70px] text-center text-lg tracking-[-0.50px]"
                shape="round"
                color="gray_50"
                size="sm"
              >
          ...
          >
            <div className="flex flex-col gap-[27px] items-start justify-start rounded-[10px] w-[94%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between rounded-[10px] w-full">
                <Button
                  className="rounded-[10px] cursor-pointer leading-[normal] min-w-[118px] text-center text-lg tracking-[-0.50px]"
                  shape="round"
                  color="gray_50"
                  size="sm"
                >
                ...
                <Button
                  className="rounded-[10px] cursor-pointer leading-[normal] min-w-[127px] text-center text-lg tracking-[-0.50px]"
                  shape="round"
                  color="gray_50"
                  size="sm"
                >
                ...
                <Button
                  className="rounded-[10px] cursor-pointer leading-[normal] min-w-[87px] text-center text-lg tracking-[-0.50px]"
                  shape="round"
                  color="gray_50"
                  size="sm"
                >
